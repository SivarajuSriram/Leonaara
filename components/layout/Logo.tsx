...
export function Logo() {
  ...
  return (
    ...
    <div className="logo-wrapper grid-container fixed w-full pt-[12.5rem] pointer-events-none max-lg:pt-[calc(9rem-4.5vh)]" ref={wrapperRef}>
      ...
      <div className="logo flex items-center justify-center [grid-column:6/span_4] pointer-events-auto [body.scrolled_&]:pointer-events-none max-lg:[grid-column:4/span_8] max-lg:justify-self-center max-lg:w-[21rem] [&_img]:h-auto [&_img]:mb-0 [&_img]:w-[56.7rem] max-lg:[&_img]:w-full">
