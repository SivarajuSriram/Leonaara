...
export const metadata: Metadata = metadataFor(winter);

export default function WinterPage() {
  const [hero, imgtext, list, galleryslider] = winter.columns.colPos0;
  ...
  return (
    <main>
      <BodyClass pageId={winter.id} layout="layout-0" />
      <Hero section={hero} />
