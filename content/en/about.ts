...
export const about: PageContent = {
  ...
  columns: {
    colPos0: [
      ...
      { id: 235, type: 'mask_hero', appearance: { layout: 'default', frameClass: 'default', spaceBefore: '', spaceAfter: '' }, content: { herolayout: 'only-text', title: '', titleh2: 'Creating Spaces That <br>Enrich Life', titleimg: '', text: '<p>Leonaara isn’t defined by what it builds alone, but by how and why it builds. At its core is a belief in development that goes beyond structures: to create trust, meaningful experiences and lasting value. We believe every piece of land holds the potential to become something more. More than a structure, more than an address and more than a development.</p><p>At Leonaara, we approach every project with the intent to create environments that are thoughtfully conceived, meaningfully designed and built around the way people truly want to live. Our focus extends beyond the physicality of what we build to the experiences, relationships and possibilities that unfold within it.</p>', img: [], sideimg: [], imgsummer: [], sideimgsummer: [] } },
