    ...
    colPos0: [
      {
        ...
        content: {
          ...
          // Leonaara is an Indian real-estate business based in Hyderabad, not
          // the Austrian mountain resort the eriro template originally
          // described -- address/phone/email below are transcribed from that
          // real page, not the eriro source.
      ...
      },
      {
        ...
        content: {
          ...
          // in Hyderabad) rather than the eriro hotel template's EU/GDPR
          // boilerplate this originally carried -- section order, headings,
          // and quoted phrasing below follow what's live on that page.
